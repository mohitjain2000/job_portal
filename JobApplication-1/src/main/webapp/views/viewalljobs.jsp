...
<%@ page import="com.mohit.SpringJdbc.Repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="row row-cols-2">
        ...
        <form action="#" method="Post">
            <div class="col mb-4">
                ...
                <%--     <a href="edit.jsp?postId=${jobPost.postId}" class="btn btn-primary">Edit</a>
                          <a href="delete?postId=${jobPost.postId}" class="btn btn-danger">Delete</a> --%> <!-- Add delete button -->
                        <button type="submit" formaction="/delete/${jobPost.postId}"  formmethod="post"   >Delete</button>
                        <button type="submit" formaction="/edit/${jobPost.postId}"  formmethod="post">Edit</button>
                    </div>
